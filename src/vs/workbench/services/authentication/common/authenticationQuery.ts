...
/**
 * Information about extensions using authentication within a provider
 */
...
/**
 * Query interface for type-agnostic operations on all extensions within a specific account
 */
export interface IAccountEntitiesQuery extends IBaseQuery {
	readonly accountName: string;

	/**
	 * Check if this account has been used by any extension
	...
	/**
	 * Remove access to this account for all extensions
	 */
	 ...
	 */
	forEach(callback: (entityId: string) => void): void;
}
...
export interface IProviderQuery extends IBaseQuery {
	...
	/**
	 * Get information about active extensions within this provider
