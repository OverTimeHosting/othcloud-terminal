...
import { SET_VARIABLE_ID, VIEW_MEMORY_ID } from './variablesView.js';
...
// Run and Debug sidebar view container removed in this fork — debug engine
// remains loaded for command-level invocation, but no activity bar entry or
// Variables/Watch/Call Stack/Breakpoints/Welcome/Loaded Scripts views are
// registered. The Debug Console (panel) is kept above.
