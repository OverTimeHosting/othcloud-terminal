...
// Editor Title Menu: Split Editor (hidden for terminal-as-editor)
const NotTerminalEditor = ResourceContextKey.Scheme.notEqualsTo(Schemas.vscodeTerminal);
...
appendEditorToolItem(
	...
	ContextKeyExpr.and(SplitEditorsVertically.negate(), NotTerminalEditor),
	SPLIT_ORDER,
	{
...
appendEditorToolItem(
	...
	ContextKeyExpr.and(SplitEditorsVertically, NotTerminalEditor),
	SPLIT_ORDER,
	{
