...
AppPublisher=OverTimeHosting Limited
AppPublisherURL=https://overtime.hosting/
AppSupportURL=https://overtime.hosting/
AppUpdatesURL=https://overtime.hosting/
DefaultGroupName={#NameLong}
AllowNoIcons=yes
OutputDir={#OutputDir}
OutputBaseFilename={#RegValueName}Setup
Compression=lzma
